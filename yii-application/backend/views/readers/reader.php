...
<div class="container">
    <div class="row">
        ...
        <div class="col-12 col-md-8 col-lg-9 mt-4 mb-3">
            <a href="<?=Url::to(['update', 'id' => $model->id])?>"><button class="btn btn-dark btn-md me-2">Edytuj</button></a>
            <a href="<?=Url::to(['borrow/create', 'id' => '', 'reader' => $model->id])?>"><button class="btn btn-success btn-md me-2">Wypożycz</button></a>
        </div>
    </div>
