    ...
    <div class="row site-row justify-content-center">
        <div class="col-12 col-md-6 col-lg-4">
            <a class="text-reset text-decoration-none text-center" href="index.php?r=books%2Findex">
                <div class="card m-5 shadow">
                    <img class="card-img-top" src="<?=Url::to('@web/site-img/books.jpg')?>" alt="Card image cap">
                    <div class="card-body">
        ...
        <div class="col-12 col-md-6 col-lg-4">
            <a class="text-reset text-decoration-none text-center" href="index.php?r=books%2Fauthors">
                <div class="card m-5 shadow">
                    <img class="card-img-top" src="<?=Url::to('@web/site-img/authors.jpg')?>" alt="Card image cap">
                    <div class="card-body">
        ...
        <div class="col-12 col-md-6 col-lg-4">
            <a class="text-reset text-decoration-none text-center" href="index.php?r=borrow%2Findex">
                <div class="card m-5 shadow">
                    <img class="card-img-top" src="<?=Url::to('@web/site-img/borrows.jpg')?>" alt="Card image cap">
                    <div class="card-body">
        ...
        <div class="col-12 col-md-6 col-lg-4">
            <a class="text-reset text-decoration-none text-center" href="index.php?r=readers%2Findex">
                <div class="card m-5 shadow">
                    <img class="card-img-top" src="<?=Url::to('@web/site-img/readers.jpg')?>" alt="Card image cap">
                    <div class="card-body">
        ...
        <div class="col-12 col-md-6 col-lg-4">
            <a class="text-reset text-decoration-none text-center" href="index.php?r=cash%2Findex">
                <div class="card m-5 shadow">
                    <img class="card-img-top" src="<?=Url::to('@web/site-img/cash.jpg')?>" alt="Card image cap">
                    <div class="card-body">
        ...
        <div class="col-12 col-md-6 col-lg-4">
            <a class="text-reset text-decoration-none text-center" href="index.php?r=reports%2Findex">
                <div class="card m-5 shadow">
                    <img class="card-img-top" src="<?=Url::to('@web/site-img/reports.jpg')?>" alt="Card image cap">
                    <div class="card-body">
